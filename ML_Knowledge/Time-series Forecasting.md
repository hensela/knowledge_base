...
- The proposition of $ARCH(𝑝)$ is that the variance $𝑣𝑎𝑟(\epsilon_𝑡) = \sigma_𝑡^2$ can be modelled in an autoregressive fashion as 
$$\sigma_𝑡^2 = \alpha_0 + \alpha_1 \sigma_{𝑡−1}^2 + ... + \alpha_𝑝 \sigma_{𝑡−𝑝}^2$$
